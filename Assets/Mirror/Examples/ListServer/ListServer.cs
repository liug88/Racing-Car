...
namespace Mirror.Examples.ListServer
{
    ...
    public class ListServer : MonoBehaviour
    {
        ...
        {
            return !manager.isHeadless && !NetworkServer.active && !FullyConnected();
        }
        ...
        void SendStatus()
        {
            ...
            writer.Write((ushort)manager.singleton.maxConnections);
        ...
        void OnUI()
        {
            ...
            if (!manager.singleton.isNetworkActive || IsConnecting())
            {
                ...
                for (int i = 0; i < list.Values.Count; ++i)
                {
                    ...
                    {
                        manager.singleton.networkAddress = server.ip;
                        manager.singleton.StartClient();
                    });
                }
            ...
            if (IsConnecting())
            {
                ...
                connectingCancelButton.onClick.AddListener(manager.singleton.StopClient);
            }
